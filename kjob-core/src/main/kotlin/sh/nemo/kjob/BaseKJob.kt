...
import sh.nemo.kjob.extension.Extension
import sh.nemo.kjob.extension.ExtensionId
import sh.nemo.kjob.extension.ExtensionModule
import sh.nemo.kjob.internal.*
import sh.nemo.kjob.internal.scheduler.JobCleanupScheduler
import sh.nemo.kjob.internal.scheduler.JobService
import sh.nemo.kjob.internal.scheduler.KeepAliveScheduler
...
abstract class BaseKJob<Config : BaseKJob.Configuration>(val config: Config) :
    KJob {
    ...
    internal open val jobExecutors: JobExecutors by lazy {
        DefaultJobExecutors(config)
    }
